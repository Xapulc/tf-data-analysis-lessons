...
class TransformerHypProblem3Variant2(VariantTransformer):
    def __init__(self, code, input_data_text, output_data_text):
        ...
        self.first_dist = gamma(a=1.017 * self.min_pv / null_gamma_scale, scale=null_gamma_scale)
        gamma_scale = 8
        self.second_dist = gamma(a=self.min_pv / gamma_scale, scale=gamma_scale)
    ...
    def get_description(self, random_state):
        ...
        problem_text = f"""
        Мы хотим запустить продажи нового продукта.
